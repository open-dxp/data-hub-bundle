...
The definition is similar to Pimcore user [workspace permissions](https://docs.opendxp.io/docs/core-framework/Development_Documentation/Administration_of_Pimcore/Users_and_Roles.html) 
