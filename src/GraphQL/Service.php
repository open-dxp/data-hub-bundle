...
use OpenDxp\Bundle\DataHubBundle\GraphQL\FieldHelper\DocumentFieldHelper;
use OpenDxp\Bundle\DataHubBundle\GraphQL\Query\Operator\Factory\OperatorFactoryInterface;
...
class Service
{
     ...
     * @param ClassDefinition|\OpenDxp\Model\DataObject\Fieldcollection\Definition|null $class
    ...
    public static function setValue($object, $attribute, $callback)
    {
        ...
        if (substr($attribute, 0, 1) === '~') {
            ...
            // with OpenDxp\Model\DataObject\Service::gridObjectData
            ...
            $key = \OpenDxp\Model\DataObject\Service::getFieldForBrickType($object->getclass(), $brickType);
