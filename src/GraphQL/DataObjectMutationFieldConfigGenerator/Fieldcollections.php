...
class Fieldcollections extends Base
{
    ...
    public function getGraphQlMutationFieldConfig($nodeDef, $class, $container = null, $params = [])
    {
        ...
        /** @var \OpenDxp\Model\DataObject\ClassDefinition\Data\Fieldcollections $fcDef */
        ...
        $processor = new \OpenDxp\Bundle\DataHubBundle\GraphQL\DataObjectInputProcessor\Fieldcollections($nodeDef, $fieldProcessors);
