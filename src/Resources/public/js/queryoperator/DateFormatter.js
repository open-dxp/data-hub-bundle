opendxp.registerNS("opendxp.plugin.datahub.queryoperator.dateformatter");

opendxp.plugin.datahub.queryoperator.dateformatter = Class.create(opendxp.plugin.datahub.Abstract, {
