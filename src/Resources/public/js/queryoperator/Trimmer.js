opendxp.registerNS("opendxp.plugin.datahub.queryoperator.trimmer");

opendxp.plugin.datahub.queryoperator.trimmer = Class.create(opendxp.plugin.datahub.Abstract, {
