opendxp.registerNS("opendxp.plugin.datahub.queryoperator.substring");

opendxp.plugin.datahub.queryoperator.substring = Class.create(opendxp.plugin.datahub.Abstract, {
    ...
    getConfigDialog: function(node, params) {
        ...
        this.textField = new Ext.form.TextField({
            fieldLabel: t('plugin_opendxp_datahub_fieldName'),
            length: 255,
            width: 200,
