opendxp.registerNS("opendxp.plugin.datahub.queryoperator.thumbnailhtml");

opendxp.plugin.datahub.queryoperator.thumbnailhtml = Class.create(opendxp.plugin.datahub.Abstract, {
