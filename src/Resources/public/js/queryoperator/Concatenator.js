opendxp.registerNS("opendxp.plugin.datahub.queryoperator.concatenator");

opendxp.plugin.datahub.queryoperator.concatenator = Class.create(opendxp.plugin.datahub.Abstract, {
