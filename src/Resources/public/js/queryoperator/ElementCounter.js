opendxp.registerNS("opendxp.plugin.datahub.queryoperator.elementcounter");

opendxp.plugin.datahub.queryoperator.elementcounter = Class.create(opendxp.plugin.datahub.Abstract, {
