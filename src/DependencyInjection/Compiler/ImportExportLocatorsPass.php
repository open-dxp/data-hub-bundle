...
class ImportExportLocatorsPass implements CompilerPassInterface
{
    ...
    protected function processGeneralTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'graphql general',
            'opendxp.datahub.graphql.generaltype_factory',
        ...
        $this->buildSupportedGeneralTypes(
            ...
            'opendxp.datahub.graphql.generaltypegenerator'
        );
    }
    ...
    protected function processAssetTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            $graphQLServiceDefinition,
            'graphql asset',
            'opendxp.datahub.graphql.assettype_factory',
    ...
    protected function processTranslationTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            $graphQLServiceDefinition,
            'graphql translation',
            'opendxp.datahub.graphql.translationtype_factory',
    ...
    protected function processDataObjectQueryTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.dataobjectquerytypegenerator',
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.dataobjectqueryoperator_factory',
    ...
    protected function processDataObjectMutationTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.dataobjectmutationtypegenerator',
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.dataobjectmutationoperator_factory',
    ...
    protected function processDocumentElementMutationTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.documentelementmutationtypegenerator',
    ...
    protected function processDocumentElementQueryTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.documentelementquerytypegenerator',
    ...
    protected function processCsFeatureQueryTypes(ContainerBuilder $container)
    {
        ...
        $this->createLocatorForTaggedServices(
            ...
            'opendxp.datahub.graphql.csfeaturequerytypegenerator',
    ...
    private function registerAssetDataTypes(
        ...
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.assettype', 'registerAssetDataTypes');
    }

    private function registerTranslationDataTypes(ContainerBuilder $container)
    {
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.translationtype', 'registerTranslationDataTypes');
    }
    ...
    private function registerDataObjectDataTypes(
        ...
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.dataobjecttype', 'registerDataObjectDataTypes');
    }

    private function registerDocumentDataTypes(
        ContainerBuilder $container
    ) {
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.documenttype', 'registerDocumentDataTypes');
    }

    private function registerClassificationStoreDataTypes(
        ContainerBuilder $container
    ) {
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.cstype', 'registerClassificationStoreDataTypes');
    }

    private function registerPropertyDataTypes(
        ContainerBuilder $container
    ) {
        $this->registerElementTypes($container, 'opendxp.datahub.graphql.propertytype', 'registerPropertyDataTypes');
    }
}
